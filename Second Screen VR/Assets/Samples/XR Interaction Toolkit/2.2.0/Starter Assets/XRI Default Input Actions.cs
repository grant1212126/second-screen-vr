...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    // Keyboard Interactions
    private readonly InputActionMap m_KeyboardInteractions;
    private IKeyboardInteractionsActions m_KeyboardInteractionsActionsCallbackInterface;
    private readonly InputAction m_KeyboardInteractions_Space;
    public struct KeyboardInteractionsActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        ...
        public void SetCallbacks(IKeyboardInteractionsActions instance)
        {
    ...
    public interface IKeyboardInteractionsActions
    {
